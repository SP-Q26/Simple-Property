...
const EM = "\u2014";
const paths = [
  { name: "home", path: "/", need: ["Deposit Desk · IL", "simple-property.css?v=9", "deposit-receipt", "40 units"], absent: ["Homestead", EM] },
  { name: "pricing", path: "/pricing", need: ["pricing-finder", "pricing-cards", "pf-units", "40 units", "Print / Save as PDF"], absent: [EM] },
  { name: "app", path: "/app", need: ["wizard-panel", "Deposit Desk · IL", "simple-property.css?v=9"], absent: [] },
  { name: "blog", path: "/blog/deposit-desk-vs-spreadsheet", need: ["Deposit Desk · IL"], absent: ["Homestead", EM] },
