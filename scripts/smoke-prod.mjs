...
const EM = "\u2014";
const paths = [
  { name: "home", path: "/", need: ["Keep the clock", "Avoid penalties", "pathway-deck", "Pick your path", "hero-rotate", "hero-share-art", "spt-share-door.png", "simple-property.css?v=30", "viewport-fit=cover", "spt-atmosphere", "spt-weather", "spt-weather-mist", "spt-greystone-pilaster", "spt-door-monogram", "deposit-receipt", "40 units", "765 ILCS", "/feedback", "Deposit Desk · start free"], absent: ["Homestead", EM, "spt-door-panel", "Pain:", "Solution:", "link previews"] },
  { name: "feedback", path: "/feedback", need: ["Suggest rulesets", "spt-feedback-form", "simple-property.css?v=30", "viewport-fit=cover"], absent: [EM] },
