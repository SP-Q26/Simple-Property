...
need("css v24 header", css.includes("v24"));
...
need("css coverage map", css.includes(".coverage-map") && css.includes(".coverage-map__dot--30"));
need("css coverage iOS hit target", css.includes(".coverage-map__hit"));
need("css coverage pointer-events split", css.includes("pointer-events: none") && css.includes(".coverage-map__dot"));
...
need("sp-nav coverage map builder", read("sp-nav.js").includes("coverage-map__hit"));
